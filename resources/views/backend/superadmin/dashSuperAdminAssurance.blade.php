            ...
            <div class="card-body">
              ...
              <div class="tab-content pt-2" id="borderedTabContent">
                  ...
                  <table class="table datatable">
	                ...
	                <tbody>
	                  @if(count($actes) != 0)
                        ...
                        <tr>
							<td class="fw-bolder align-middle">{{ $acte->code_assurance }}</td>
							<td class=""><img src="/assets/img{{ $acte->logo }}" alt="" style="width: 60px; height: 40px; border-radius: 5px"> </td>
							<td class="align-middle fw-bolder">{{ $acte->nom_assurance }}</td>
							<td class="align-middle text-sm-center" style="font-size: 12px">{{ $acte->statut_juridique }}</td>
							<td class="align-middle text-sm-center">{{ $acte->bp }}</td>
							<td class="fw-bolder align-middle">{{ $acte->tel }}</td>
							<td class="align-middle"><a href="{{ $acte->site_web }}">{{ $acte->site_web }}</a></td>
							<td class="text-center align-middle">
                                <button type="button" class="btn p-0 px-1 btn-outline-success" data-bs-toggle="modal" data-bs-target="#{{ $acte->code_assurance }}">
                                    <i class="bi bi-eye-fill pe-none"></i>
                                </button>
                                <button type="button" class="btn p-0 px-1 btn-outline-warning" data-bs-toggle="modal" data-bs-target="#edit{{ $acte->code_assurance }}">
                                    <i class="bi bi-pencil-fill"></i>
                                </button>
								<a href="{{ URL::to('dashboard/root/edit-acte') }}/{{ $acte->id }}" class="btn p-0 px-1 btn-outline-danger"><i class="bi bi-trash-fill"></i></a>
							</td>
                            <!-- Modal SEE -->
                            <div class="modal fade" id="{{ $acte->code_assurance }}" tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title fw-bolder" id="">Assurances #{{ $acte->id }}</h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 d-flex flex-column align-content-between">
                                                    <label class="form-label fw-bolder">Code Assurance</label>
                                                    <input type="text" class="form-control mb-1" value="{{ $acte->code_assurance }}" disabled>

                                                    <label class="form-label fw-bolder">Nom Assurance</label>
                                                    <input type="text" class="form-control mb-1" value="{{ $acte->nom_assurance }}" disabled>

                                                    <label class="form-label fw-bolder">Telephone Assurance</label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 d-flex flex-column align-content-between">
                                                    ...
                                                    <input type="text" class="form-control mb-1" value="{{ $acte->site_web }}" disabled>
                                                </div>
                                        </div>
                                        </div>
                                    </div>
                            ...
                            <!-- Modal Edit -->
                            <div class="modal fade" id="edit{{ $acte->code_assurance }}" tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title fw-bolder" id="">Edit Assurance #{{ $acte->id }}</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <form method="POST" enctype="multipart/form-data" action="{{ route('updateAssuranceSuperAdmin') }}">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-6 d-flex flex-column align-content-between">
                                                        <label class="form-label fw-bolder">logo Assurance</label>
                                                        <input class="form-control" type="file" id="formFile" name="picass">
                                                    </div>
                                                    <div class="col-md-12 d-flex flex-column align-content-between">
                                                        <label class="form-label fw-bolder">Code Assurance</label>
                                                        <input type="text" class="form-control mb-1" value="{{ $acte->code_assurance }}" name="code">

                                                        <label class="form-label fw-bolder">Nom Assurance</label>
                                                        <input type="text" class="form-control mb-1" value="{{ $acte->nom_assurance }}" name="nom">
                ...
                <div class="tab-pane fade" id="bordered-profile" role="tabpanel" aria-labelledby="profile-tab">
					<form method="POST" enctype="multipart/form-data" action="{{ route('newAssuranceSuperAdmin') }}">
						@csrf
						<div class="card border-0 shadow-none mb-0">
							<div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 d-flex flex-column align-content-between">
                                        <label class="form-label fw-bolder">Site Web</label>
                                        <input type="text" class="form-control mb-1" value="{{old('site')}}" name="site" required>
                                    </div>
                                </div>
                                <div class="d-grid gap-2 mt-3">
